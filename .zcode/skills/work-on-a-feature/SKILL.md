---
name: work-on-a-feature
description: >
  Start work on a new feature, bug fix, or hotfix. Use when the user wants to
  begin a new piece of work — takes a description, picks the branch type
  (feature/bugfix/hotfix), and handles all the git setup.
---
