...
Real filesystem — only ``scratchpad._DIR`` is redirected (via the autouse
``_isolate_scratchpad`` fixture in the integration conftest) so tests never
touch the real ~/.tableintelligence.

Mirrors: src/tabint/shared/scratchpad.py
"""
